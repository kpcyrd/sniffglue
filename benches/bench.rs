...
mod tests {
    ...
    fn tcp(b: &mut Bencher) {
        ...
        let mut pkt = Vec::new();
        pkt.extend(&[
            0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, // Destination MAC
            0x11, 0x22, 0x33, 0x44, 0x55, 0x66, // Source MAC
            8, 0, 69, 0, 1, 186, 78, 105, 64, 0, 55, 6, 251, 115, // Ethernet and IP
            93, 184, 216, 34, // Source IP
            192, 168, 44, 55, // Destination IP
            // IP and TCP
            0, 80, 142, 158, 133, 72, 141, 7, 64, 115, 177, 1, 128, 24, 1, 27, 200, 121, 0, 0, 1, 1,
            8, 10, 59, 135, 198, 7, 93, 127, 194, 19,
        ]);
